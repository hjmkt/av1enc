...
pub struct CDF {
    ...
    palette_uv_size: [[i32; PALETTE_SIZES+1]; PALETTE_BLOCK_SIZE_CONTEXTS],
...
pub const default_cdf: CDF = CDF {
    ...
    mv_class0_hp: [ 160*128, 32768, 0 ],
    mv_hp: [ 128*128, 32768, 0 ],
    mv_sign: [ 128*128, 32768, 0 ],
    mv_bit: [
        [ 136*128, 32768, 0 ],
        [ 140*128, 32768, 0 ],
        [ 148*128, 32768, 0 ],
    ...
    mv_joint: [ 4096, 11264, 19328, 32768, 0 ],
    mv_class: [
