...
pub struct CDF {
    ...
    pub uv_mode_cfl_not_allowed: [[i32; UV_INTRA_MODES_CFL_NOT_ALLOWED+1]; INTRA_MODES],
    pub uv_mode_cfl_allowed: [[i32; UV_INTRA_MODES_CFL_ALLOWED+1]; INTRA_MODES],
    pub angle_delta: [[i32; (2*MAX_ANGLE_DELTA+1)+1]; DIRECTIONAL_MODES],
    pub intrabc: [i32; 2+1],
    pub partition_w8: [[i32; 5]; PARTITION_CONTEXTS],
    pub partition_w16: [[i32; 11]; PARTITION_CONTEXTS],
    pub partition_w32: [[i32; 11]; PARTITION_CONTEXTS],
    pub partition_w64: [[i32; 11]; PARTITION_CONTEXTS],
    pub partition_w128: [[i32; 9]; PARTITION_CONTEXTS],
    pub tx_8x8: [[i32; MAX_TX_DEPTH+1]; TX_SIZE_CONTEXTS],
    pub tx_16x16: [[i32; MAX_TX_DEPTH+2]; TX_SIZE_CONTEXTS],
    pub tx_32x32: [[i32; MAX_TX_DEPTH+2]; TX_SIZE_CONTEXTS],
    pub tx_64x64: [[i32; MAX_TX_DEPTH+2]; TX_SIZE_CONTEXTS],
    pub txfm_split: [[i32; 3]; TXFM_PARTITION_CONTEXTS],
    pub filter_intra_mode: [i32; 6],
    pub filter_intra: [[i32; 3]; BLOCK_SIZES],
    pub segment_id: [[i32; MAX_SEGMENTS+1]; SEGMENT_ID_CONTEXTS],
    pub segment_id_predicted: [[i32; 3]; SEGMENT_ID_PREDICTED_CONTEXTS],
    pub mv_class0_hp: [[[i32; 3]; 2]; MV_CONTEXTS],
    pub mv_hp: [[[i32; 3]; 2]; MV_CONTEXTS],
    pub mv_sign: [[[i32; 3]; 2]; MV_CONTEXTS],
    pub mv_bit: [[[[i32; 3]; MV_OFFSET_BITS]; 2]; MV_CONTEXTS],
    pub mv_class0_bit: [[[i32; 3]; 2]; MV_CONTEXTS],
    pub new_mv: [[i32; 3]; NEW_MV_CONTEXTS],
    pub zero_mv: [[i32; 3]; ZERO_MV_CONTEXTS],
    pub ref_mv: [[i32; 3]; REF_MV_CONTEXTS],
    pub drl_mode: [[i32; 3]; DRL_MODE_CONTEXTS],
    pub is_inter: [[i32; 3]; IS_INTER_CONTEXTS],
    pub comp_mode: [[i32; 3]; COMP_INTER_CONTEXTS],
    pub skip_mode: [[i32; 3]; SKIP_MODE_CONTEXTS],
    pub skip: [[i32; 3]; SKIP_CONTEXTS],
    pub comp_ref: [[[i32; 3]; FWD_REFS-1]; REF_CONTEXTS],
    pub comp_bwd_ref: [[[i32; 3]; BWD_REFS-1]; REF_CONTEXTS],
    pub single_ref: [[[i32; 3]; SINGLE_REFS-1]; REF_CONTEXTS],
    pub compound_mode: [[i32; COMPOUND_MODES+1]; COMPOUND_MODE_CONTEXTS],
    pub interp_filter: [[i32; INTERP_FILTERS+1]; INTERP_FILTER_CONTEXTS],
    pub motion_mode: [[i32; MOTION_MODES+1]; BLOCK_SIZES],
    pub mv_joint: [[i32; MV_JOINTS+1]; MV_CONTEXTS],
    pub mv_class: [[[i32; MV_CLASSES+1]; 2]; MV_CONTEXTS],
    pub mv_class0_fr: [[[[i32; MV_JOINTS+1]; CLASS0_SIZE]; 2]; MV_CONTEXTS],
    pub mv_fr: [[[i32; MV_JOINTS+1]; 2]; MV_CONTEXTS],
    pub palette_y_size: [[i32; PALETTE_SIZES+1]; PALETTE_BLOCK_SIZE_CONTEXTS],
    pub palette_uv_size: [[i32; PALETTE_SIZES+1]; PALETTE_BLOCK_SIZE_CONTEXTS],
    pub palette_size_2_y_color: [[i32; 3]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_3_y_color: [[i32; 4]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_4_y_color: [[i32; 5]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_5_y_color: [[i32; 6]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_6_y_color: [[i32; 7]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_7_y_color: [[i32; 8]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_8_y_color: [[i32; 9]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_2_uv_color: [[i32; 3]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_3_uv_color: [[i32; 4]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_4_uv_color: [[i32; 5]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_5_uv_color: [[i32; 6]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_6_uv_color: [[i32; 7]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_7_uv_color: [[i32; 8]; PALETTE_COLOR_CONTEXTS],
    pub palette_size_8_uv_color: [[i32; 9]; PALETTE_COLOR_CONTEXTS],
    pub palette_y_mode: [[[i32; 3]; PALETTE_Y_MODE_CONTEXTS]; PALETTE_BLOCK_SIZE_CONTEXTS],
    pub palette_uv_mode: [[i32; 3]; PALETTE_UV_MODE_CONTEXTS],
    pub delta_q: [i32; DELTA_Q_SMALL+2],
    pub delta_lf: [i32; DELTA_LF_SMALL+2],
    pub delta_lf_multi: [[i32; DELTA_LF_SMALL+2]; FRAME_LF_COUNT],
    pub intra_tx_type_set1: [[[i32; 8]; INTRA_MODES]; 4],
    pub intra_tx_type_set2: [[[i32; 6]; INTRA_MODES]; 4],
    pub inter_tx_type_set1: [[i32; 17]; 4],
    pub inter_tx_type_set2: [[i32; 13]; 4],
    pub inter_tx_type_set3: [[i32; 3]; 4],
    pub compound_idx: [[i32; 3]; COMPOUND_IDX_CONTEXTS],
    pub comp_group_idx: [[i32; 3]; COMP_GROUP_IDX_CONTEXTS],
    pub compound_type: [[i32; COMPOUND_TYPES+1]; BLOCK_SIZES],
    pub inter_intra: [[i32; 3]; BLOCK_SIZE_GROUPS],
    pub inter_intra_mode: [[i32; INTERINTRA_MODES+1]; BLOCK_SIZE_GROUPS],
    pub wedge_index: [[i32; 16+1]; BLOCK_SIZES],
    pub wedge_inter_intra: [[i32; 3]; BLOCK_SIZES],
    pub use_obmc: [[i32; 3]; BLOCK_SIZES],
    pub comp_ref_type: [[i32; 3]; COMP_REF_TYPE_CONTEXTS],
    pub uni_comp_ref: [[[i32; 3]; UNIDIR_COMP_REFS-1]; REF_CONTEXTS],
    pub cfl_sign: [i32; CFL_JOINT_SIGNS+1],
    pub cfl_alpha: [[i32; CFL_ALPHABET_SIZE+1]; CFL_ALPHA_CONTEXTS],
    pub use_wiener: [i32; 2+1],
    pub use_sgrproj: [i32; 2+1],
    pub restoration_type: [i32; RESTORE_SWITCHABLE as usize +1],
    pub txb_skip: [[[[i32; 3]; TXB_SKIP_CONTEXTS]; TX_SIZES]; COEFF_CDF_Q_CTXS],
    pub eob_pt_16: [[[[i32; 6]; 2]; PLANE_TYPES]; COEFF_CDF_Q_CTXS],
    pub eob_pt_32: [[[[i32; 7]; 2]; PLANE_TYPES]; COEFF_CDF_Q_CTXS],
    pub eob_pt_64: [[[[i32; 8]; 2]; PLANE_TYPES]; COEFF_CDF_Q_CTXS],
    pub eob_pt_128: [[[[i32; 9]; 2]; PLANE_TYPES]; COEFF_CDF_Q_CTXS],
    pub eob_pt_256: [[[[i32; 10]; 2]; PLANE_TYPES]; COEFF_CDF_Q_CTXS],
    pub eob_pt_512: [[[[i32; 11]; 2]; PLANE_TYPES]; COEFF_CDF_Q_CTXS],
    pub eob_pt_1024: [[[[i32; 12]; 2]; PLANE_TYPES]; COEFF_CDF_Q_CTXS],
    pub eob_extra: [[[[[i32; 3]; EOB_COEF_CONTEXTS]; PLANE_TYPES]; TX_SIZES]; COEFF_CDF_Q_CTXS],
    pub dc_sign: [[[[i32; 3]; DC_SIGN_CONTEXTS]; PLANE_TYPES]; COEFF_CDF_Q_CTXS],
    pub coeff_base_eob: [[[[[i32; 4]; SIG_COEF_CONTEXTS_EOB]; PLANE_TYPES]; TX_SIZES]; COEFF_CDF_Q_CTXS],
    pub coeff_base: [[[[[i32; 5]; SIG_COEF_CONTEXTS]; PLANE_TYPES]; TX_SIZES]; COEFF_CDF_Q_CTXS],
    pub coeff_br: [[[[[i32; BR_CDF_SIZE+1]; LEVEL_CONTEXTS]; PLANE_TYPES]; TX_SIZES]; COEFF_CDF_Q_CTXS],
}

pub const default_cdf: CDF = CDF {
    intra_frame_y_mode: [
        [
    ...
    filter_intra_mode: [ 8949, 12776, 17211, 29558, 32768, 0 ],
    filter_intra: [
    ...
    mv_class0_hp: [[[ 160*128, 32768, 0 ]; 2]; MV_CONTEXTS],
    mv_hp: [[[ 128*128, 32768, 0 ]; 2]; MV_CONTEXTS],
    mv_sign: [[[ 128*128, 32768, 0 ]; 2]; MV_CONTEXTS],
    mv_bit: [[[
        [ 136*128, 32768, 0 ],
        [ 140*128, 32768, 0 ],
        [ 148*128, 32768, 0 ],
    ...
    mv_class0_bit: [[[ 216*128, 32768, 0 ]; 2]; MV_CONTEXTS],
    new_mv: [
        [ 24035, 32768, 0 ],
        [ 16630, 32768, 0 ],
        [ 15339, 32768, 0 ],
    ...
    mv_joint: [[ 4096, 11264, 19328, 32768, 0 ]; MV_CONTEXTS],
    mv_class: [[
    ...
    palette_uv_mode: [ [ 32461, 32768, 0 ], [ 21488, 32768, 0 ] ],
    delta_q: [ 28160, 32120, 32677, 32768, 0 ],
    delta_lf: [ 28160, 32120, 32677, 32768, 0 ],
    delta_lf_multi: [[ 28160, 32120, 32677, 32768, 0 ]; FRAME_LF_COUNT],
    intra_tx_type_set1: [
        [
    ...
    inter_tx_type_set1: [
        ...
        20480, 22528, 24576, 26624, 28672, 30720, 32768, 0 ],
        [ 2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
        20480, 22528, 24576, 26624, 28672, 30720, 32768, 0 ]
    ],
    inter_tx_type_set2: [
        [ 2731, 5461, 8192, 10923, 13653, 16384, 19115, 21845,
        24576, 27307, 30037, 32768, 0 ],
        [ 2731, 5461, 8192, 10923, 13653, 16384, 19115, 21845,
        24576, 27307, 30037, 32768, 0 ],
    ...
    cfl_sign: [ 1418, 2123, 13340, 18405, 26972, 28343, 32294, 32768, 0 ],
    cfl_alpha: [
    ...
    use_wiener: [ 11570, 32768, 0 ],
    use_sgrproj: [ 16855, 32768, 0 ],
    restoration_type: [ 9413, 22581, 32768, 0 ],
    txb_skip: [
        [
            [ [ 31849, 32768, 0 ],
            [ 5892, 32768, 0 ],
